...
export const MidCar = () => {
   ...
   const [carlength,Setcarlength] = React.useState(false);
const [page,setPage] = React.useState(1)
    ...
    const getData = () => {
        ...
        fetch(`https://travelcity-car-hotal.herokuapp.com/cars?page=${page}`)
            ...
            .then((res) => {
                setCarData(res.data)
                Setcarlength((res.totalcars)===res.data.length)
                // console.log(res)
            })
    ...
    return (
        ...
        <div>
            ...
            <Wraper>
                    ...
                    loding ? <div className="progress">
                        ...
                        return <CarDiv key={data.id}>
                            ...
                            <div className='price'>
                               ...
                               <Link to={`/carreserve/${data._id}`}><Button onClick={() => handleReserve(data.id)} >Reserve</Button></Link> 
                            </div>
                ...
                {page>1 && <Button1 onClick={()=>{
                    setPage(page-1)
                }} style={{justifyContent : "center"}}>Show Less</Button1>}

                <Button1  onClick={()=>{
                    setPage(page+1)
                }} disabled ={carlength} style={{justifyContent : "center"}}>Show More</Button1>
